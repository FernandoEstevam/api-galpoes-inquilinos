...
import { warehouseBaseSchema, warehouseInputIdSchema, warehouseInputParamsSchema, warehouseInputUpdateSchema, warehouseOutputCreateSchema, warehouseOutputDeleteSchema, warehouseOutputListSchema, warehouseOutputSchema } from "@/schemas/warehouse.schema";
import { FastifyInstance } from "fastify";

export const WarehouseRoutes = (app: FastifyInstance) => {
